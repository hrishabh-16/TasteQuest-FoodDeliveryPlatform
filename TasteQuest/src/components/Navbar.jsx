...
import { FiShoppingCart, FiUser, FiSearch, FiChevronDown } from 'react-icons/fi';
...
const Navbar = () => {
  ...
  const handleIconClick = () => {
    handleSearch(new Event('click')); // Trigger the search
  };
      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <Link to="/cart" className="flex items-center">
            <FiShoppingCart className="mr-2" /> <span className="hidden sm:inline">Cart</span>
          </Link>
          ...
          {user ? (
            ...
            <>
              <Link to="/login" className="flex items-center">
                <FiUser className="mr-2" /> <span className="hidden sm:inline">Login</span>
              </Link>
              <Link to="/register" className="flex items-center">
                <FiUser className="mr-2" /> <span className="hidden sm:inline">Register</span>
              </Link>
            </>
          )}
        </div>
